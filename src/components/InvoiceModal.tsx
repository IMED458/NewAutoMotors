...
export default function InvoiceModal({ order, services, issuedBy, onClose }: InvoiceModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[70] bg-slate-950/80 backdrop-blur-sm p-4 overflow-y-auto print:bg-white print:p-0">
      <section id="print-invoice" className="invoice-sheet mx-auto my-4 max-w-3xl bg-white text-slate-950 rounded-2xl p-5 md:p-8 shadow-2xl print:my-0 print:max-w-none print:rounded-none print:shadow-none">
        ...
        <header className="invoice-header grid grid-cols-1 gap-5 md:grid-cols-2">
